...
def home():
    return render_template("frontendML.html")
...
def get_prediction():
    ...
    prediction = model.predict(baby_df)  #it is in numpy array format
    ...
    return render_template("frontendML.html", prediction=prediction)
